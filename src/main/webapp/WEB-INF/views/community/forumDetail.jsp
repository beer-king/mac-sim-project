...
<body>
          ...
          <div>
            <div class="fode__addco-wrapper">
              ...
              <div class="fode__input-box">
                ...
                />
                <button style="width: 100px;"type="button" onclick="replyInsert(${fo.forNo});">등록</button>
              </div>
            </div>
	                ...
	                <div class="fode__co-info">
	                  ...
	                  <div>
	                    <c:choose>
	                      ...
	                      <c:otherwise>
	                    	<span><button class="bt" type="button" data-toggle="modal" data-target="#myModal" data-num="${ r.coNo }">신고</button></span>
	                      </c:otherwise>
	                    </c:choose>
		                    ...
		                    <div class="fode__co-info">
		                      ...
		                      <div>
		                        <c:choose>
			                      ...
			                      <c:otherwise>
			                        <span><button class="bt" type="button" data-toggle="modal" data-target="#myModal2" data-num="${ sr.recoNo }">신고</button></span>
			                      </c:otherwise>
		                        </c:choose>
	...
	<div class="modal fade" id="myModal">
		...
		<div class="modal-dialog">
		  ...
		  <form id="form1">
		    <h4>신고사유</h4>
		    <select id="reqCateNo2" name="reqCateNo2" style="width: 200px;">
		      <option value="1">욕설</option>
		      <option value="2">중복, 도배</option>
		      <option value="3">정치적 발언</option>
		      <option value="4">기타</option>
		    ...
		    <br><br>
		    <h4>상세사유</h4>
		    <textarea name="reqContent2" id="reqContent2" cols="30" rows="10" style="width: 400px; height: 100; resize: none;"></textarea>
		  </form>
		  </div>
		  
		  <!-- Modal footer -->
		      <div class="modal-footer">
		        <button id="call2" type="button" class="btn btn-primary" data-dismiss="modal">제출하기</button>
		        <button type="button" class="btn btn-danger" data-dismiss="modal">취소하기</button>
		      </div>
    	...
    	$("#call2").click(function(){
        	call2();
   		  ...
   		  $.ajax({
   			  url:"callInsert.ad",
   			  type:"POST",
   			  data:{reqCateNo:$("#reqCateNo2").val(),
   				  reqContent:$("#reqContent2").val(),
   				  reqNum:num,
   				  rfromNo:5},
