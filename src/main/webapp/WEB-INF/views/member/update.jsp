...
<script>
    ...
    <div id="deleteMember">
        <ol>
            <li><span>탈퇴 후 회원정보 및 개인형 서비스 이용기록은 모두 삭제됩니다.
                        회원정보 및 나의 와인셀러 등 개인형 서비스 이용기록은 모두 삭제되며, 삭제된 데이터는 복구되지 않습니다.</span> </li>

            <li><span>탈퇴 후에도 공개형 서비스에 등록된 게시물은 그대로 남아 있습니다.
                      공개형 서비스라 함은 시음 노트, 등록한 뉴스 또는 이벤트, 참여한 이벤트 내역, 구인안내 등을 말합니다.</span></li>

            <li><span>삭제를 원하시는 게시글이 있다면 반드시 탈퇴 전 삭제하시기 바랍니다.</span></li>
        </ol>
