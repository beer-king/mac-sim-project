                ...
                <form id="enrollForm" method="post" action="" enctype="">
                    <table align="center">
                        ...
                        <tr>
                            ...
                            <th><textarea class="form-control" required name="" id="content" rows="10" style="resize:none;"></textarea></th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="evBeer" class="form-control" placeholder="시음회시 제공되는 맥주입니다."></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="evPeople" class="form-control" placeholder="모집할 회원수를 입력하세요."></td>
                        </tr>
                        <tr>
